...
export const STUDIO = {
  ...
  /* three product cards, each carrying two pills */
  cards: [
    {
    ...
    {
      src: "/media/product/showroom-b.webp",
      alt: "Cushions in Sarom upholstery fabrics",
      family: "Chenille",
      name: "Cortina",
    },
    {
      src: "/media/product/showroom-c.webp",
      alt: "A styled living setting in Sarom fabrics",
      family: "Jacquard",
      name: "Jodhpur",
    },
  ],
  feature: {
    ...
    body: "Curated fabrics that bring considered design and comfort into every space.",
    tagName: "Drift Lounge",
    tagMeta: "Bouclé",
  },
  panel: {
    // two explicit lines: 14ch wrapped this to four
